...
namespace DataGridViewAutoFilter
{
    ...
    /// </summary>
    public class DataGridViewAutoFilterFullTextBoxColumn : DataGridViewTextBoxColumn
    {
        ...
        /// </summary>
        public DataGridViewAutoFilterFullTextBoxColumn() : base()
        {
        ...
        public new Type DefaultHeaderCellType
        {
            get
            {
                return typeof(DataGridViewAutoFilterFullColumnHeaderCell);
            }
        }
        ...
        public Boolean FilteringEnabled
        {
            get
            {
                ...
                return ((DataGridViewAutoFilterFullColumnHeaderCell)HeaderCell)
                    .FilteringEnabled;
            }
            set
            {
                // Set the header-cell property. 
                ((DataGridViewAutoFilterFullColumnHeaderCell)HeaderCell)
        ...
        {
            DataGridViewAutoFilterFullColumnHeaderCell.RemoveFilter(dataGridView);
        }
        ...
        {
            return DataGridViewAutoFilterFullColumnHeaderCell.GetFilterStatus(dataGridView);
        }
