...
namespace DataGridViewAutoFilter
{
    ...
    /// </summary>
    public class DataGridViewAutoFilterSingleColumnHeaderCell : DataGridViewAutoFilterHeaderCell
    {
        /// <summary>
        /// The ListBox used for all drop-down lists. 
        /// </summary>
        private SingleSelectHeaderList filterWindow;
        ...
        public DataGridViewAutoFilterSingleColumnHeaderCell(DataGridViewColumnHeaderCell oldHeaderCell) : base(oldHeaderCell)
        {
        ...
        /// class. 
        /// </summary>
        public DataGridViewAutoFilterSingleColumnHeaderCell() : base()
        {
        }
        ...
        {
            filterWindow.MouseClick += new MouseEventHandler(DropDownListBox_MouseClick);
        ...
        private void DropDownListBox_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (!filterWindow.DisplayRectangle.Contains(e.X, e.Y))
            {
                return;
            }
