...
namespace DataGridViewAutoFilter
{
    ...
    /// </summary>
    public class DataGridViewAutoFilterMultiTextBoxColumn : DataGridViewTextBoxColumn
    {
        ...
        /// </summary>
        public DataGridViewAutoFilterMultiTextBoxColumn() : base()
        {
        ...
        public new Type DefaultHeaderCellType
        {
            get
            {
                return typeof(DataGridViewAutoFilterMultiColumnHeaderCell);
            }
        }
        ...
        public Boolean FilteringEnabled
        {
            get
            {
                ...
                return ((DataGridViewAutoFilterMultiColumnHeaderCell)HeaderCell)
                    .FilteringEnabled;
            }
            set
            {
                // Set the header-cell property. 
                ((DataGridViewAutoFilterMultiColumnHeaderCell)HeaderCell)
        ...
        {
            DataGridViewAutoFilterMultiColumnHeaderCell.RemoveFilter(dataGridView);
        }
        ...
        {
            return DataGridViewAutoFilterMultiColumnHeaderCell.GetFilterStatus(dataGridView);
        }
